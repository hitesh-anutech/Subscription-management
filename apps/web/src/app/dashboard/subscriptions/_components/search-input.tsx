...
export function SubscriptionSearchInput({ defaultValue }: { defaultValue?: string }) {
  ...
  return (
    <input
      ...
      className="w-full px-3 py-1.5 rounded-lg border border-slate-200 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 bg-slate-50/50"
    />
  );
}
